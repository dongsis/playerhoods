-- ============================================================================
-- Fix — RLS recursion between groups <-> group_members (v2, correct columns)
-- ============================================================================
begin;
...
-- 3) groups SELECT policy: stop direct reference to group_members table
...
-- 4) group_members SELECT policies: stop direct reference to groups table
