-- Allow organizer to \"Invite back\" removed participants even if they are no longer
-- in current scope/share-group. First-time invites still enforce the scope gate.
