-- Fix inbound SMS parsing for the natural format we send to players:
-- "Reply YES 3YQIF..." / user replies "YES 3YQIF". The previous parser grabbed
-- the first 4-6 char token, saw YES, then discarded it and never checked 3YQIF.
