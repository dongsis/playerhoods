...
BEGIN
  ...
  SET
    ...
    show_in_venue_member_discovery = CASE WHEN p_show_in_venue_member_discovery IS NOT NULL THEN p_show_in_venue_member_discovery ELSE show_in_venue_member_discovery END,
...
ALTER FUNCTION "public"."rpc_profile_update"("p_first_name" "text", "p_last_name" "text", "p_contact_channel" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_show_in_venue_member_discovery" boolean, "p_allow_non_group_invites" boolean) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."rpc_profile_update"("p_first_name" "text", "p_last_name" "text", "p_contact_channel" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_show_in_venue_member_discovery" boolean, "p_allow_non_group_invites" boolean) IS 'v1.7 + Phase 1: Update profile. Includes global preference switches: show_in_venue_member_discovery, allow_non_group_invites.';
...
GRANT ALL ON FUNCTION "public"."rpc_profile_update"("p_first_name" "text", "p_last_name" "text", "p_contact_channel" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_show_in_venue_member_discovery" boolean, "p_allow_non_group_invites" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."rpc_profile_update"("p_first_name" "text", "p_last_name" "text", "p_contact_channel" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_show_in_venue_member_discovery" boolean, "p_allow_non_group_invites" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."rpc_profile_update"("p_first_name" "text", "p_last_name" "text", "p_contact_channel" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_show_in_venue_member_discovery" boolean, "p_allow_non_group_invites" boolean) TO "service_role";
