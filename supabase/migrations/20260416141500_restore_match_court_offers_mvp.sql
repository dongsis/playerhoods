...
CREATE UNIQUE INDEX IF NOT EXISTS uq_match_court_offers_match_volunteer
  ON public.match_court_offers(match_id, volunteer_user_id);
...
BEGIN
  ...
  ON CONFLICT (match_id, volunteer_user_id)
  DO UPDATE SET
