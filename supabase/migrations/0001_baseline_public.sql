...
--
-- Name: compute_match_start_at_utc(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.compute_match_start_at_utc() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_timezone text;
...
--
-- Name: do_users_share_group(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.do_users_share_group(p_user_a uuid, p_user_b uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT EXISTS (
...
--
-- Name: FUNCTION do_users_share_group(p_user_a uuid, p_user_b uuid); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.do_users_share_group(p_user_a uuid, p_user_b uuid) IS 'v1.6.1: Returns true if both users are active members of at least one common group. SECURITY DEFINER. NOT granted to authenticated — internal RPC use only.';


--
-- Name: fn_guard_participant_state(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_guard_participant_state() RETURNS trigger
    LANGUAGE plpgsql
...
--
-- Name: fn_match_detail_change_reconfirm(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_match_detail_change_reconfirm() RETURNS trigger
...
--
-- Name: FUNCTION fn_match_detail_change_reconfirm(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: is_caller_in_match_scope(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_caller_in_match_scope(p_match_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
...
--
-- Name: FUNCTION is_caller_in_match_scope(p_match_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: is_caller_match_associated(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_caller_match_associated(p_match_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT public.is_user_match_associated(p_match_id, auth.uid());
$$;
...
--
-- Name: is_guest_in_any_group_roster(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_guest_in_any_group_roster(p_guest_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT FALSE;
...
--
-- Name: is_user_in_scope_groups(uuid[], uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_user_in_scope_groups(p_scope_group_ids uuid[], p_user_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    SET row_security TO 'off'
    AS $$
...
--
-- Name: FUNCTION is_user_in_scope_groups(p_scope_group_ids uuid[], p_user_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: is_user_match_associated(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_user_match_associated(p_match_id uuid, p_user_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT EXISTS (
...
--
-- Name: FUNCTION is_user_match_associated(p_match_id uuid, p_user_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: log_participant_action(uuid, text, text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_participant_action(p_match_participant_id uuid, p_action_type text, p_note text DEFAULT NULL::text, p_created_by uuid DEFAULT auth.uid()) RETURNS void
    LANGUAGE plpgsql
    SET search_path TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  -- guests: confirmed iff org_approved_at exists
  ...
  -- users: confirmed iff accepted + org_approved
...
--
-- Name: rpc_admin_user_search(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_admin_user_search(p_query text) RETURNS TABLE(user_id uuid, display_name text, email text)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: rpc_club_admin_grant(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_club_admin_grant(p_user_id uuid, p_club_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: rpc_club_admin_revoke(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_club_admin_revoke(p_user_id uuid, p_club_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: COLUMN clubs.timezone; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: rpc_club_create(text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_club_create(p_name text, p_location_text text DEFAULT NULL::text, p_timezone text DEFAULT 'America/Toronto'::text, p_notes text DEFAULT NULL::text) RETURNS public.clubs
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_club_handle_check(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_club_handle_check(p_club_id uuid, p_handle text) RETURNS TABLE(available boolean, suggestions text[])
...
--
-- Name: rpc_club_handle_set(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_club_handle_set(p_club_id uuid, p_new_handle text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_club_join(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_club_join(p_club_id uuid, p_handle text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_club_update(uuid, text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_club_update(p_club_id uuid, p_name text DEFAULT NULL::text, p_location_text text DEFAULT NULL::text, p_timezone text DEFAULT NULL::text, p_notes text DEFAULT NULL::text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: rpc_court_create(uuid, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_court_create(p_club_id uuid, p_court_code text, p_surface text DEFAULT NULL::text, p_notes text DEFAULT NULL::text) RETURNS public.courts
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_court_delete(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_court_delete(p_court_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_court_update(uuid, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_court_update(p_court_id uuid, p_court_code text DEFAULT NULL::text, p_surface text DEFAULT NULL::text, p_notes text DEFAULT NULL::text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: COLUMN group_members.group_display_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: rpc_group_set_display_name(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_group_set_display_name(p_group_id uuid, p_display_name text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: COLUMN match_participants.participant_accepted_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN match_participants.participant_accepted_via; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN match_participants.manual_confirmed_by; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: rpc_match_add_guest_org(uuid, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_add_guest_org(p_match_id uuid, p_guest_display_name text, p_guest_notes text DEFAULT NULL::text, p_note text DEFAULT NULL::text) RETURNS public.match_participants
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  INSERT INTO match_participants (
    ...
    p_match_id, v_new_guest_id, 'guest_add', 'confirmed',
...
--
-- Name: rpc_match_add_guest_participant(uuid, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_add_guest_participant(p_match_id uuid, p_guest_display_name text, p_guest_notes text DEFAULT NULL::text, p_note text DEFAULT NULL::text) RETURNS public.match_participants
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: COLUMN matches.start_at_utc; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: rpc_match_delegate_confirm_user(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_delegate_confirm_user(p_match_id uuid, p_user_id uuid) RETURNS public.match_participants
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: FUNCTION rpc_match_delegate_confirm_user(p_match_id uuid, p_user_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: rpc_match_delegate_manual_confirm_targets(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_delegate_manual_confirm_targets(p_match_id uuid) RETURNS TABLE(user_id uuid, display_name text)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  IF NOT public.is_user_in_scope_groups(v_match.invitation_scope_group_ids, v_uid)
    ...
    RETURN; -- UI-friendly: empty (per你的约定)
  END IF;
...
--
-- Name: rpc_match_invite_guest_from_roster(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_invite_guest_from_roster(p_match_id uuid, p_guest_id uuid) RETURNS public.match_participants
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  -- Ensure guest exists and active
  IF NOT EXISTS (
  ...
  -- If reconcile exists, keep your invariant consistent
  BEGIN
    PERFORM public.match_participant_reconcile_status(v_mp.id);
  EXCEPTION WHEN undefined_function THEN
    -- ok: reconcile not installed in this environment
    NULL;
  END;
...
--
-- Name: rpc_match_invite_targets(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_invite_targets(p_match_id uuid) RETURNS TABLE(user_id uuid, display_name text)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
...
--
-- Name: FUNCTION rpc_match_invite_targets(p_match_id uuid); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.rpc_match_invite_targets(p_match_id uuid) IS 'v1.6.1: Returns eligible invite targets for organizer. Target set: InScope UNION ShareGroup(*, organizer_id). Excludes self and already-active (pending/confirmed). RAISE on unauthorized caller (debug-friendly admin entry point).';
...
--
-- Name: rpc_match_manual_confirm(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_manual_confirm(p_match_participant_id uuid, p_note text DEFAULT NULL::text) RETURNS public.match_participants
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: FUNCTION rpc_match_manual_confirm(p_match_participant_id uuid, p_note text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: rpc_match_manual_confirm_user(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_manual_confirm_user(p_match_id uuid, p_user_id uuid) RETURNS public.match_participants
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: FUNCTION rpc_match_manual_confirm_user(p_match_id uuid, p_user_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: rpc_match_nominate_targets(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_match_nominate_targets(p_match_id uuid) RETURNS TABLE(user_id uuid, display_name text)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
#variable_conflict use_column
...
--
-- Name: FUNCTION rpc_match_nominate_targets(p_match_id uuid); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.rpc_match_nominate_targets(p_match_id uuid) IS 'v1.6.1: Returns eligible nomination targets for non-org participants. Caller: non-org + can_participants_invite_users + (InScope OR MatchAssociated). Returns empty (no exception) if gate fails — UI-friendly. Target set: ShareGroup(*, caller). Excludes self, organizer, already-active.';
...
--
-- Name: rpc_profile_init(text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_profile_init(p_display_name text, p_first_name text DEFAULT NULL::text, p_last_name text DEFAULT NULL::text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_profile_set_display_name(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_profile_set_display_name(p_display_name text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_profile_set_primary_club(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_profile_set_primary_club(p_club_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_profile_update(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_profile_update(p_first_name text DEFAULT NULL::text, p_last_name text DEFAULT NULL::text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: rpc_roster_guest_create(text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_roster_guest_create(p_display_name text, p_email text DEFAULT NULL::text, p_phone text DEFAULT NULL::text) RETURNS public.guests
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_roster_guest_create(text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_roster_guest_create(p_display_name text, p_email text DEFAULT NULL::text, p_phone text DEFAULT NULL::text, p_notes text DEFAULT NULL::text) RETURNS public.guests
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: rpc_roster_guest_list(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rpc_roster_guest_list() RETURNS SETOF public.guests
...
--
-- Name: sharegroup_exists(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sharegroup_exists(p_user_a uuid, p_user_b uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT EXISTS (
...
--
-- Name: test_runner_v161(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.test_runner_v161() RETURNS TABLE(test_name text, ok boolean, details text, match_id uuid)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $_$
DECLARE
...
--
-- Name: test_runner_v161_cleanup(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.test_runner_v161_cleanup() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: test_runner_v161_cleanup(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.test_runner_v161_cleanup(p_run_suffix text) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: tg__set_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: trg_set_removed_at_from_status(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trg_set_removed_at_from_status() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO 'public', 'pg_temp'
    AS $$
BEGIN
...
--
-- Name: validate_club_handle(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_club_handle(p_handle text) RETURNS text
...
--
-- Name: club_identities; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: VIEW match_counts; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: match_courts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: VIEW match_formed; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: match_participant_actions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE match_participant_actions; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: profile_display; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_personal_remarks (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: TABLE user_personal_remarks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN user_personal_remarks.group_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: user_roster_guests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_roster_guests (
...
--
-- Name: v_group_member_display; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_group_member_display AS
 SELECT gm.group_id,
...
--
-- Name: VIEW v_group_member_display; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: club_identities club_identities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_courts match_courts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_participant_actions match_participant_actions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: club_admins uq_club_admin; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: club_identities uq_club_identity_handle_norm; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: club_identities uq_club_identity_user; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_courts uq_match_court_slot; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks user_personal_remarks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks user_personal_remarks_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_roster_guests user_roster_guests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_mpa_match; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mpa_participant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_roster_guests_guest; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_roster_guests_owner; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: mpa_match_id_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: mpa_mp_id_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_match_participants_active_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_mp_active_guest; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_mp_active_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_mpa_dedup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks set_updated_at__user_personal_remarks; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at__user_personal_remarks BEFORE UPDATE ON public.user_personal_remarks FOR EACH ROW EXECUTE FUNCTION public.tg__set_updated_at();


--
-- Name: matches trg_compute_match_start_at_utc; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_compute_match_start_at_utc BEFORE INSERT OR UPDATE OF match_date, start_time, club_id ON public.matches FOR EACH ROW EXECUTE FUNCTION public.compute_match_start_at_utc();


--
-- Name: match_participants trg_guard_participant_state; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_guard_participant_state BEFORE UPDATE ON public.match_participants FOR EACH ROW EXECUTE FUNCTION public.fn_guard_participant_state();


--
-- Name: matches trg_match_detail_change_reconfirm; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_match_detail_change_reconfirm AFTER UPDATE OF match_date, start_time, duration_minutes ON public.matches FOR EACH ROW EXECUTE FUNCTION public.fn_match_detail_change_reconfirm();


--
-- Name: match_participants trg_set_removed_at_from_status; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_set_removed_at_from_status BEFORE UPDATE OF status ON public.match_participants FOR EACH ROW EXECUTE FUNCTION public.trg_set_removed_at_from_status();
...
--
-- Name: club_admins club_admins_granted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: club_identities club_identities_club_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: club_identities club_identities_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_courts match_courts_match_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_participant_actions match_participant_actions_match_participant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: match_participants match_participants_manual_confirmed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks user_personal_remarks_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks user_personal_remarks_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks user_personal_remarks_target_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_roster_guests user_roster_guests_guest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: club_admins; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.club_admins ENABLE ROW LEVEL SECURITY;

--
-- Name: club_admins club_admins_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: club_identities; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.club_identities ENABLE ROW LEVEL SECURITY;

--
-- Name: club_identities club_identities_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: guests guests_select_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: guests guests_write_none; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: match_courts; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.match_courts ENABLE ROW LEVEL SECURITY;

--
-- Name: match_courts match_courts_delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: match_courts match_courts_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: match_courts match_courts_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: match_courts match_courts_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: match_participant_actions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.match_participant_actions ENABLE ROW LEVEL SECURITY;

--
-- Name: match_participant_actions match_participant_actions_select_organizer; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: match_participants match_participants_insert_guest; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: POLICY match_participants_insert_guest ON match_participants; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: match_participants match_participants_select_v1_6_1; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY match_participants_select_v1_6_1 ON public.match_participants FOR SELECT TO authenticated USING ((public.is_match_organizer(match_id, auth.uid()) OR (user_id = auth.uid()) OR ((status = 'confirmed'::public.match_participant_status) AND (public.is_caller_in_match_scope(match_id) OR public.sharegroup_exists(auth.uid(), ( SELECT m.organizer_id
   FROM public.matches m
  WHERE (m.id = match_participants.match_id))) OR public.is_caller_match_associated(match_id)))));
...
--
-- Name: POLICY matches_select_visibility ON matches; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: match_participant_actions mpa_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks upr_delete_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks upr_insert_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks upr_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks upr_update_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_personal_remarks; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.user_personal_remarks ENABLE ROW LEVEL SECURITY;

--
-- Name: user_roster_guests; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.user_roster_guests ENABLE ROW LEVEL SECURITY;

--
-- Name: user_roster_guests user_roster_guests_select_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_roster_guests user_roster_guests_write_none; Type: POLICY; Schema: public; Owner: -
--
