...
CREATE OR REPLACE TRIGGER "trg_match_detail_change_reconfirm" AFTER UPDATE OF "match_date", "start_time", "duration_minutes" ON "public"."matches" FOR EACH ROW EXECUTE FUNCTION "public"."fn_match_detail_change_reconfirm"();
...
REVOKE ALL ON FUNCTION "public"."do_users_share_group"("p_user_a" "uuid", "p_user_b" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."is_club_admin"("p_club_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."is_user_match_associated"("p_match_id" "uuid", "p_user_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_admin_user_search"("p_query" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_club_admin_grant"("p_user_id" "uuid", "p_club_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_club_admin_revoke"("p_user_id" "uuid", "p_club_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_club_create"("p_name" "text", "p_location_text" "text", "p_timezone" "text", "p_notes" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_club_handle_check"("p_club_id" "uuid", "p_handle" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_club_handle_set"("p_club_id" "uuid", "p_new_handle" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_club_join"("p_club_id" "uuid", "p_handle" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_club_update"("p_club_id" "uuid", "p_name" "text", "p_location_text" "text", "p_timezone" "text", "p_notes" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_court_create"("p_club_id" "uuid", "p_court_code" "text", "p_surface" "text", "p_notes" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_court_delete"("p_court_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_court_update"("p_court_id" "uuid", "p_court_code" "text", "p_surface" "text", "p_notes" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_group_create"("p_name" "text", "p_description" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_accept_invite"("p_match_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_delegate_confirm_user"("p_match_id" "uuid", "p_user_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_delegate_manual_confirm_targets"("p_match_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_invite_targets"("p_match_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_invite_user"("p_match_id" "uuid", "p_user_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_manual_confirm_user"("p_match_id" "uuid", "p_user_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_nominate_targets"("p_match_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_match_nominate_user"("p_match_id" "uuid", "p_user_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_profile_init"("p_display_name" "text", "p_first_name" "text", "p_last_name" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_profile_set_display_name"("p_display_name" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_profile_set_primary_club"("p_club_id" "uuid") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."rpc_profile_update"("p_first_name" "text", "p_last_name" "text") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."validate_club_handle"("p_handle" "text") FROM PUBLIC;
...
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."club_admins" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."club_admins" TO "authenticated";
