...
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-06-05 | MR-20260605-create-match-players-step2-simplify | Mini Release | Simplifies Create Match Step 2 Players UI into Invite / Post Player Call modes. | 0961f32c6c6ae252cf5224bae4f13666e3b31c77 | None | Not deployed yet | No change | Local visual screenshots only; authenticated Preview smoke skipped | Ready for Review / GitHub only | Rollback: Revert PR #104 and redeploy previous production commit. Codex PR review failed due to GitHub Action quota, not code failure. |
