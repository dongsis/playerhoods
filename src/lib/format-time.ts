 ...
 * Centralised time-formatting helpers using Intl.DateTimeFormat (no external deps).
 */

/** Format a match's start time in club timezone. Returns "Mon, Jan 5, 14:00" style. */
...
/** Human-readable action_type label for the activity feed. */
