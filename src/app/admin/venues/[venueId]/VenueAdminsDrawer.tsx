...
import type { VenueAdminWithDetails, AdminUserSearchResult } from '@/lib/types/database'
...
export function VenueAdminsDrawer({ admins, onSearch, onGrant, onRevoke }: Props) {
