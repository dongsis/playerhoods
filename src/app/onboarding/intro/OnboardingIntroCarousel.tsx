      ...
      <section className="mx-auto flex min-h-screen w-full max-w-[1180px] flex-col px-5 py-5 sm:px-8 sm:py-7">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-[12px] font-extrabold uppercase tracking-[0.18em] text-[#1C63E8]">
            <Image src="/playerhoods-brand-stacked-cropped.png" alt="PlayerHoods" width={1512} height={375} className="h-9 w-36 object-contain" />
          </div>
          <button
            type="button"
            onClick={finish}
          ...
          <div className="grid w-full place-items-center">
            {slide.kind === 'welcome' ? (
              <div className="mx-auto grid max-w-[760px] place-items-center text-center">
                <div className="mb-8 flex h-24 w-64 items-center justify-center rounded-[28px] bg-white shadow-[0_18px_50px_rgba(28,99,232,0.16)]">
                  <Image src="/playerhoods-brand-stacked-cropped.png" alt="PlayerHoods" width={1512} height={375} className="h-16 w-56 object-contain" priority />
                </div>
